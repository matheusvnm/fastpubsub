...
async def after_started():
    broker.publish(topic_name="topic_a", data={"some_message": "messageA"})
    broker.publish(topic_name="topic_b", data={"some_message": "messageA"})
    broker.publish(topic_name="topic_c", data={"some_message": "messageA"})
